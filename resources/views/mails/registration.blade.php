...
<table width="100%" bgcolor="#ffffff" cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
    ...
    <tr>
        <td>
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" style="border-bottom: 1px solid #d1d1d1;">
                <tbody>
                <tr>
                    <td width="100%">
                                    ...
                                    <table width="100" align="left" border="0" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="left" valign="middle"
                                                ...
                                                class="mobile-hide">
                                                <div class="imgpop">
                                                    <a target="_blank" href="https://scandinaver.org">
                                                        <img src="https://scandinaver.org/img/mails/b1.png"
                                                             alt=""
                                                             border="0"
                                                             height="30"
                                    ...
                                    <table width="100" align="right" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            <td width="30" height="30" align="right">
                                                <div class="imgpop">
                                                    <a target="_blank" href="#">
                                                        <img src="https://scandinaver.org/img/mails/vk.png"
                                                             alt=""
                                                             border="0"
                                                             width="30"
                                                             height="30"
                                            ...
                                            <td width="30" height="30" align="center">
                                                <div class="imgpop">
                                                    <a target="_blank" href="#">
                                                        <img src="https://scandinaver.org/img/mails/in.png"
                                                             alt=""
                                                             border="0"
                                                             width="30"
                                                             height="30"
                                            ...
                                            <td width="30" height="30" align="center">
                                                <div class="imgpop">
                                                    <a target="_blank" href="#">
                                                        <img src="https://scandinaver.org/img/mails/tw.png"
                                                             alt=""
                                                             border="0"
                                                             width="30"
                                                             height="30"
                        ...
                        <table width="600" cellpadding="0" cellspacing="0" border="0" align="center"
                            ...
                            <tr>
                                <td align="center" valign="middle"
                                    style="font-family: Helvetica, arial, sans-serif; font-size: 14px;color: #666666">
                                    <p>Это автоматическое e-mail сообщение – просим вас не отвечать.</p>
                                    <br>
                                    <p>support@scandinaver.org</p>
                                </td>
                            </tr>
                            <!-- Spacing -->
                            <tr>
