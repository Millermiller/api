 ...
 * Generated for Laravel 5.7.29 on 2020-09-03 19:08:56.
 *
...
namespace Laravolt\Avatar { 
    ...
    class Facade {
        ...
        {
            return \Laravolt\Avatar\Avatar::setChars($chars);
        }
...
namespace {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model
    {
        ...
        {
            return Builder::fromSub($query, $as);
        }
        ...
        {
            return Builder::fromRaw($expression, $bindings);
        }
        ...
        public static function joinSub(
            ...
            return Builder::joinSub($query, $as, $first, $operator, $second, $type, $where);
        }
        ...
        {
            return Builder::leftJoinSub($query, $as, $first, $operator, $second);
        }
        ...
        {
            return Builder::rightJoinSub($query, $as, $first, $operator, $second);
        }
        ...
        {
            return Builder::whereIntegerInRaw($column, $values, $boolean, $not);
        }
        ...
        {
            return Builder::whereIntegerNotInRaw($column, $values, $boolean);
        }
        ...
        {
            return Builder::orWhereDay($column, $operator, $value);
        }
        ...
        {
            return Builder::orWhereMonth($column, $operator, $value);
        }
        ...
        {
            return Builder::orWhereYear($column, $operator, $value);
        }
        ...
        {
            return Builder::whereRowValues($columns, $operator, $values, $boolean);
        }
        ...
        {
            return Builder::orWhereRowValues($columns, $operator, $values);
        }
        ...
        {
            return Builder::whereJsonContains($column, $value, $boolean, $not);
        }
        ...
        {
            return Builder::orWhereJsonContains($column, $value);
        }
        ...
        {
            return Builder::whereJsonDoesntContain($column, $value, $boolean);
        }
        ...
        {
            return Builder::orWhereJsonDoesntContain($column, $value);
        }
        ...
        {
            return Builder::whereJsonLength($column, $operator, $value, $boolean);
        }
        ...
        {
            return Builder::orWhereJsonLength($column, $operator, $value);
        }
        ...
        {
            return Builder::havingBetween($column, $values, $boolean, $not);
        }
        ...
        {
            return Builder::insertUsing($columns, $query);
        }
