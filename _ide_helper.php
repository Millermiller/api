 ...
 */
     ...
     */ 
        ...
        {            //Method inherited from \Illuminate\Auth\Passwords\PasswordBrokerManager         
                        /** @var \LaravelDoctrine\ORM\Auth\Passwords\PasswordBrokerManager $instance */
...
')
     ...
     */ 
         ...
         *
         * @param mixed[]|\Doctrine\ORM\Connection $connection An array with the connection parameters or an existing Connection instance.
         * @param \Doctrine\ORM\Configuration $config The Configuration instance to use.
         * @param \Doctrine\ORM\EventManager|null $eventManager The EventManager instance to use.
