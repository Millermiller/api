    ...
    */
    'managers'                   => [
        'default' => [
            ...
            'namespaces'    => [],
            'paths'         => [
                //base_path('src/Scandinaver/Learn/Domain/Model'),
                //base_path('src/Scandinaver/Blog/Domain/Model'),
                //base_path('src/Scandinaver/Common/Domain/Model'),
                //base_path('src/Scandinaver/Puzzle/Domain/Model'),
                //base_path('src/Scandinaver/Translate/Domain/Model'),
                //base_path('src/Scandinaver/User/Domain/Model'),

                base_path('src/Scandinaver/Puzzle/Infrastructure/Persistence/Doctrine/Mapping') => 'Scandinaver\Puzzle\Domain',
                base_path('src/Scandinaver/User/Infrastructure/Persistence/Doctrine/Mapping') => 'Scandinaver\User\Domain',
                base_path('src/Scandinaver/Translate/Infrastructure/Persistence/Doctrine/Mapping') => 'Scandinaver\Translate\Domain',
                base_path('src/Scandinaver/Common/Infrastructure/Persistence/Doctrine/Mapping') => 'Scandinaver\Common\Domain',
                base_path('src/Scandinaver/Blog/Infrastructure/Persistence/Doctrine/Mapping') => 'Scandinaver\Blog\Domain',
                base_path('src/Scandinaver/Learn/Infrastructure/Persistence/Doctrine/Mapping') => 'Scandinaver\Learn\Domain',
            ],
